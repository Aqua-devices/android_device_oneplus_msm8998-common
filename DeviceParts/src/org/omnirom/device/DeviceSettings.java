...
public class DeviceSettings extends PreferenceFragment implements
    ...
    private TwoStatePreference mHWKSwitch;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        // remove these categories as they are not supported out the box
        // users can use their favorite kernel manager app for these
        // if they are using a kernel that supports this stuff
        getPreferenceScreen().removePreference(findPreference("vib_category"));
        getPreferenceScreen().removePreference(findPreference("buttons_category"));
        getPreferenceScreen().removePreference(findPreference("graphics"));
    }
